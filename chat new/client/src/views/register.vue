    ...
    <div class="form-container">
      ...
      <div class="form" :style="{ backgroundImage: bg1 }">
        ...
        <div class="social-icons">
          <a
            href="https://whispering-everglades-42925.herokuapp.com/auth/google"
            target="_self"
            ><i class="fab fa-google"></i
          ></a>
          <a
            href="https://whispering-everglades-42925.herokuapp.com/auth/facebook"
            target="_self"
            ><i class="fab fa-facebook-square"></i
          ></a>
          <a href="#" target="_self"><i class="fab fa-twitter"></i></a>
          <a
            href="https://whispering-everglades-42925.herokuapp.com/auth/github"
            target="_self"
  ...
  methods: {
    register() {
      ...
      if (this.validateForm(self.user)) {
        this.disabled = true;
        this.$http
          .post("http://localhost:9876/api/auth/register", self.user)
          .then((response) => {
            this.disabled = false;
