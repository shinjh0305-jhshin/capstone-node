...
export default {
  ...
  methods: {
    ...
    findChannel(ChannelName) {
      ...
      this.$http
        .get(
          "https://whispering-everglades-42925.herokuapp.com/channels/name/" +
            ChannelName
        )
        .then((res) => {
          this.finding = false;
    ...
    joinNewChannel(channel) {
      ...
      this.$http
        .post(
          "https://whispering-everglades-42925.herokuapp.com/channels/" +
            channel._id
        )
        .then((res) => {
          this.joining = false;
  ...
  mounted() {
    ...
    this.$http
      .get(
        "https://whispering-everglades-42925.herokuapp.com/users/currentUser"
      )
      .then((res) => {
        if (res.data.isLoggedIn === false) {
          ...
          this.$http
            .get(
              "https://whispering-everglades-42925.herokuapp.com/users/currentUser/channels"
            )
            .then((res) => {
